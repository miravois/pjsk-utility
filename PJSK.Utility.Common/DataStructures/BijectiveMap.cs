...
namespace PJSK.Utility.Common.DataStructures
{
    public class BijectiveMap<TKey, TValue>
    {
        ...
        public BijectiveMap(EqualityComparer<TKey> keyComparer, EqualityComparer<TValue> valueComparer)
            : this(0, EqualityComparer<TKey>.Default, EqualityComparer<TValue>.Default)
        {
        }

        public BijectiveMap(int capacity, EqualityComparer<TKey> keyComparer, EqualityComparer<TValue> valueComparer)
        {
